...
@export var dialogue_lines: Array[String] = [
	...
	"It seems we're stuck here on an island...[i]just you and me huh?[/i]",
	"Unfortunately my talent is trash as the [b]Ultimate Lucky Student[/b]...so I'm not much help.",
	"Luckily you guys are talented, but if you all want to be developers, you're gonna need a lot of luck to reach the top.",
	"But take it from me, with a little bit of hope...",
	"[b]YOU'LL ALL BE THE [i][color=yellow]ULTIMATE GAME DEVELOPERS!!![/i][/b]",
	"[b]AHAHAHAAHAHAHAHAHAHAAHAHAHAHAHAHAHAHAHAAHAHAHAHAHAHAAHAHAHAHAHAAHAHAHAAHAHAHAHAHAHAAHAHAHAHAHA!!!![/b]"
]
...
func _ready():
	images = [$"../Happy", $"../Normal",$"../Think", $"../Sad", $"../Think", $"../Crazy", $"../UltraCrazy", $"../UltraCrazy"]
	for img in images:
		img.visible = false
